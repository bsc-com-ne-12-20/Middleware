...
from .views import change_password,agent_deposit, e_signet_callback, verify_identity, register_agent, agent_login, agent_logout, agent_withdraw, agent_transaction_history
...
urlpatterns = [
    ...
    path('e_signet_callback/', e_signet_callback, name='e_signet_callback'),
